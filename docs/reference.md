...
| `jetson`     | Home Manager | `gars`              | n/a            | `sway`       | none          |
...
- Standalone Home Manager target for Fedora on Apple Silicon (Asahi Linux)
- apply with `nhms` or `nh home switch .#fedora-mac`
