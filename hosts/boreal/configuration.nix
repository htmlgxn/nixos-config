...
# =============================================================================
# Hardware-specific configuration for the boreal host.
# Includes: boot, hardware drivers, filesystems, network, users.
#
# TO ADD A NEW HOST:
...
#    - Filesystem mounts (UUIDs will be different)
#    - User configuration
# 4. Add NixOS configuration in flake.nix:
